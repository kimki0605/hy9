...
public class PolyMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("Cat 타입 인스턴스가 Animal 참조변수로 대입되면서 형변환 발생");
		a.show();
		a.sound();
		...
		a.show();
		//a.show1(); //Cat2 인스턴스가 대입이 되었지만 Cat2인스턴스의 일반멤버는 사용불가능 부모클래스 멤버만 사용 가능
		
		//상솓된 또다른 객체 인스턴스도 대입 가능
		a = d; //Animal = Dog
		a.show();
		a.sound();
