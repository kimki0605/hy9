...
<html>
	...
	<body>
		...
		퍼센트 : <fmt:formatNumber value="${price}" type="parcent" groupingUsed="false"/><br>
		<hr>
		...
		<fmt:formatDate value="${now}" type="both" dateStyle="full" timeStyle="full"/><br><!-- 2026년 9월 1일 화요일 오후 4시 26분 26초 대한민국 표준시 -->
		
		<hr>
		<h3>fmt:formatDate 태그 이용한 날짜 포맷팅-출력형식 지정</h3>
		<fmt:formatDate value="${now}" pattern="YYYY-MM-dd:mm:ss"/>
