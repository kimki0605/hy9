...
public class BinarySearchTree<E> {
	...
	private final Comparator<? super E> comparator; //<? super E> 제네릭타임 E와 E의 모든 부모 클래스 포함
	
	//type에 비교정의객체가 구현되어 있는 타입인 경우
	public BinarySearchTree() {
		this(null);
	}
	//type에 비교정의객체가 미구현 타입인 경우 Comparator 인터페이스를 구현한 구현객체가 전달되어야 함
	...
	//전딜되는 객체에 따라 Comparable 또는 Comparator중 하나의 사용이 가능하도록 2개 메서드 생성
